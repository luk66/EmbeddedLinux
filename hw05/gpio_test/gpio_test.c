...
static unsigned int gpioLED = 48;       ///< hard coding the LED gpio for this example to P9_13 (GPIO48)
static unsigned int gpioButton = 51;   ///< hard coding the button gpio for this example to P9_15 (GPIO51)
